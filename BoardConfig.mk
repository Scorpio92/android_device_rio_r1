...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/gigabyte/rio/bluetooth
...
BOARD_HARDWARE_CLASS := device/gigabyte/rio/cmhw

# RIL
BOARD_RIL_CLASS := ../../../device/gigabyte/rio/ril/

# GPS
BOARD_USES_QCOM_GPS := true
BOARD_VENDOR_QCOM_GPS_LOC_API_HARDWARE := rio
